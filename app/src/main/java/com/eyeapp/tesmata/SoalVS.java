 ...
 */
public class SoalVS extends Activity {
    Database    db;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.menu_soal_visus);

        imgSoal  = (ImageView) findViewById(R.id.imgLoadGambarVisus);
        a0       = (RadioGroup) findViewById(R.id.rdoGroupVS);
        rdoSoal1 = (RadioButton) findViewById(R.id.rdoJawaban_vs_1);
        rdoSoal2 = (RadioButton) findViewById(R.id.rdoJawaban_vs_2);
        rdoSoal3 = (RadioButton) findViewById(R.id.rdoJawaban_vs_3);
        rdoSoal4 = (RadioButton) findViewById(R.id.rdoJawaban_vs_4);
        btn_OK   = (Button) findViewById(R.id.btnJawab_vs);
        ...
        btn_OK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (i < n) {
                    ...
                    AlertDialog.Builder build = new AlertDialog.Builder(SoalVS.this);
                    hasil = (skor / 20) * 100;
                    if(skor <= 10){
                        ket = "Anda Tidak Lulus Ujian Visus";
                    }else{
                        ket = "Anda Lulus Ujian Visus";
                    }
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        getMenuInflater().inflate(R.menu.soal_vs, menu);
        return true;
    }
}
